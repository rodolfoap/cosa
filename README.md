...
The model only knows a small synthetic world (17 drinks, 8 attributes such as fizzy, sweet, hot). See [system_formal_description.md](system_formal_description.md) for the model, [Implementation.md](Implementation.md) for development notes and results.
